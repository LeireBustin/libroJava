...
public class Libro implements Imprimible, Vendible {
	...
	/*
	 * Se puede acceder desde el mismo "package" o desde otro. Desde la propia
	 * clase. Desde cualquier "subclase" o "Clase Hija", pero no se puede ver desde
	 * una clase de otro "package".
	 */
